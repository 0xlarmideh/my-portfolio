  ...
  return (
    <div>
      <div>
        ...
        /> */}
        <Paragraph
          title="I am skilled in using various technologies for frontend and backend development, always looking to improve and stay current with industry trends. I am excited to continue to push the boundaries of what is possible and create visually stunning designs and functional APIs and backend infrastructure."
